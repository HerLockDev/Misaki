...
from misaki_installer import hata, bilgi, onemli, soru
...
def main():
        ...
        if soup.title.string == "Create new application":
            ...
            app_title = choice(["misak", "misaki", "tg", "madelineproto", "telethon", "pyrogram"]) + choice(["user", "bt", "vue", "jsx", "python", "php"]) + choice(["", "_"]) + choice([str(randint(10000, 99999))])
            app_shortname = choice(["misak", "misaki", "tg", "madelineproto", "telethon", "pyrogram"]) + choice(["user", "bt", "vue", "jsx", "python", "php"]) + choice(["", "_"]) + choice([str(randint(10000, 99999))])
            AppInfo = {
                "hash": hashh,
                "app_title": app_title,
